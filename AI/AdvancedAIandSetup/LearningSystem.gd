...
func learn_from_combat(enemy: FPSAgent, outcome: String) -> void:
...
func learn_from_damage(attacker: GameEntity, damage: float):
...
func adapt_strategy(enemy: FPSAgent) -> void:
